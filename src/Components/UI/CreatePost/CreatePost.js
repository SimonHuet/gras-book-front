...
export default props => {
  ...
  useEffect(() => {
    ...
    if (postUuid !== undefined) {
      ...
      setIsUpdated(true);
      console.log('euhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh');
      // }
    }
  }, [posts]);
  ...
  const actionPost = () => {
    ...
    fetchBackend(process.env.REACT_APP_POST_API, url, {
      ...
      .then(res => console.log('resultat createpost'))
      .catch(res => console.log('error', res)); // ( props.history.push('/Home', null));
  };
